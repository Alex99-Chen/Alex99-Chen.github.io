...
arrResult.forEach(function(item,i,arr){
    strHtml = strHtml + '<a style="color:red;" href="'+item.link+'">'+item.title+'<a><br>'
})
document.getElementsByClassName('app')[0].innerHTML = strHtml